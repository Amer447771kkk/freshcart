            ...
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-xl bg-primary-100 flex items-center justify-center shrink-0">
                <svg
                  data-prefix="fas"
                  data-icon="truck"
                  className="svg-inline--fa fa-truck text-primary-600 text-lg"
                  role="img"
                  viewBox="0 0 576 512"
                  aria-hidden="true"
                >
            ...
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-xl bg-primary-100 flex items-center justify-center shrink-0">
                <svg
                  ...
                  className="svg-inline--fa fa-arrow-rotate-left text-primary-600 text-lg"
                  role="img"
                  viewBox="0 0 512 512"
                  aria-hidden="true"
                >
            ...
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-xl bg-primary-100 flex items-center justify-center shrink-0">
                <svg
                  ...
                  className="svg-inline--fa fa-shield-halved text-primary-600 text-lg"
                  role="img"
                  viewBox="0 0 512 512"
                  aria-hidden="true"
                >
